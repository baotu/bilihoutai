			...
			<el-container>
				<el-main class="el-main">
					<el-tabs type="border-card">
						<el-tab-pane label="视频评论">
							<el-table style="width: 100%" :data="tables.slice((pageIndex-1)*pageSize,pageIndex*pageSize)">
								<el-table-column :show-overflow-tooltip="true" label="评论内容" prop="commentcontain"></el-table-column>
								<el-table-column :show-overflow-tooltip="true" label="视频名称" prop="xyvideo.videoname"></el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			handleDelete(index, row) {
				...
				this.$confirm('此操作将永久删除该评论, 是否继续?', '提示', {
					...
					this.$axios.get('xyvideocomment/deleteById.do', {
						params: {
		...
		mounted() {
			...
			this.$axios.get('xyvideocomment/findByVideoId.do', {
				params: {
					videoid : videoid
				}
			})
